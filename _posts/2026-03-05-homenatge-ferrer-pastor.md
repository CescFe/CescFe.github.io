...
{% assign post_image_max_width_medium = "520px" %}

<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid loading="eager" path="assets/img/posts/homenatge_ferrer_pastor/01_homenatge_ferrer_pastor.png" alt="Retrat_Francesc_Ferrer_Pastor" class=post_image_class max-width=post_image_max_width_medium %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/03_homenatge_ferrer_pastor.png" alt="Font_dels_Xorros_detall" class=post_image_class max-width=post_image_max_width_default %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/04_homenatge_ferrer_pastor.png" alt="Miquel_Martí_i_Pol" class=post_image_class max-width=post_image_max_width_medium %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/05_homenatge_ferrer_pastor.png" alt="Diccionaris_Ferrer_Pastor" class=post_image_class max-width=post_image_max_width_default %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/06_homenatge_ferrer_pastor.png" alt="Casament_Ferrer_Pastor_i_Vicenta_Escrivà" class=post_image_class max-width=post_image_max_width_medium %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/07_homenatge_ferrer_pastor.png" alt="Serra_Agullent" class=post_image_class max-width=post_image_max_width_default %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/08_homenatge_ferrer_pastor.png" alt="Claustre_mestres_rat_penat" class=post_image_class max-width=post_image_max_width_default %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/09_homenatge_ferrer_pastor.png" alt="Diccionari_amb_anotacions" class=post_image_class max-width=post_image_max_width_medium %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/10_homenatge_ferrer_pastor.png" alt="Tomba_Joan_Francesc_Carròs" class=post_image_class max-width=post_image_max_width_default %}
</div>
<br>
...
<div class="col-sm mt-3 mt-md-0 text-center">
    {% include figure.liquid path="assets/img/posts/homenatge_ferrer_pastor/11_homenatge_ferrer_pastor.png" alt="Coberta_Vocabulari_Sicania" class=post_image_class max-width=post_image_max_width_medium %}
</div>
<br>
