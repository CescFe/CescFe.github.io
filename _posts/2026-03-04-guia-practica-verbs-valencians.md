...
Aquesta guia pràctica recull els principals models de conjugació dels verbs valencians, amb els temps simples i composts, les irregularitats més habituals i una selecció de participis freqüents. Està pensada com una ferramenta de consulta clara i ràpida, tant per a resoldre dubtes puntuals com per a repassar d'un colp d'ull les formes verbals més usuals.

Si escrius, dones classe, estudies o simplement vols guanyar seguretat a l'hora de conjugar, ací trobaràs una referència ordenada per conjugacions i per tipus d'irregularitat. Això et permet localitzar amb facilitat el model que segueix cada verb i comprovar quines variants o canvis presenta.
...
{% include verbs/14-guia-dormir-temps-simples.html %}
...
{% include verbs/16-guia-dormir-temps-compostos.html %}

> Els temps composts de la 3ª conjugació són idèntics als de la 1ª conjugació.
