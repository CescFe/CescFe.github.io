...
import pytest
import os
from scripts.generate_books import file_exists, load_json, validate_json_structure, generate_book_markdown_files
...
def test_create_books_md(source_books_json_path):
    ...
    try:
        created_files = generate_book_markdown_files(books, output_dir)
